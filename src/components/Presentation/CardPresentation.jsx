...
export const CardPresentation = ({ img, title, subtitle, description1, description2, description3, description4 }) => {
  return (
    <div className="max-w-full bg-white rounded-2xl shadow-lg flex flex-col md:flex-row overflow-hidden">
      {/* Imagen */}
      <div className="w-full aspect-[4/3] md:w-1/3 md:aspect-auto md:h-auto flex-shrink-0">
        <img
      ...
      {/* Texto */}
      <div className="flex-1 bg-gray-100 px-4 py-4 md:px-6 flex flex-col justify-center">
        <div className="font-extrabold text-lg md:text-xl text-[#051d40] mb-1">{title}</div>
